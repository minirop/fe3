...
L8197AA:
	...
	cmp #$FF
	bne L8197CC
	lda.l ActiveUnit.Weapon2,X
	sta.l ActiveUnit.Weapon1,X
	lda.l ActiveUnit.Weapon2Uses,X
	sta.l ActiveUnit.Weapon1Uses,X
	lda #$FF
	sta.l ActiveUnit.Weapon2,X
	sta.l ActiveUnit.Weapon2Uses,X
L8197CC:
	inx
	txa
	cmp #$03
...
L8197DA:
	...
	cmp #$FF
	bne L8197FC
	lda.l ActiveUnit.Item2,X
	sta.l ActiveUnit.Item1,X
	lda.l ActiveUnit.Item2Uses,X
	sta.l ActiveUnit.Item1Uses,X
	lda #$FF
	sta.l ActiveUnit.Item2,X
	sta.l ActiveUnit.Item2Uses,X
L8197FC:
	inx
	txa
	cmp #$03
...
L81D1A8:
DMA_DATA $7F5250 $0020 $90

L81D1AF:
DMA_DATA $7F5270 $0020 $A0
...
L81D4BE:
.db $01 $01 $04 $10 $10 $0C
.db $81 $00 $00 $00 $08 $02

.db $01 $01 $05 $C0 $10 $03
.db $81 $00 $00 $01 $16 $02

.db $01 $11 $04 $10 $90 $0C
.db $82 $40 $00 $00 $08 $12

.db $01 $11 $05 $C0 $90 $03
.db $82 $40 $00 $01 $16 $12
